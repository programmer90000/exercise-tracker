...
const Home = () => (
  <div>
    ...
    <div className="first-section">
      <img  className='image1' src="./public/hm-image1.jpg"></img>
    ...
    <div className="second-section">
      ...
      <img className="image2" src="./public/hm-image2.jpg"></img>
    </div>
    <div className="third-section">
      <img  className='image3' src="./public/Smartwatch-1.jpeg"></img>
